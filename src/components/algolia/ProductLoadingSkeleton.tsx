...
const ProductLoadingSkeleton: React.FC<{ items?: number }> = ({ items = 6 }) => (
      ...
      <div key={`skeleton-element-${key}`} className="group flex flex-1 flex-col w-full mx-auto mb-auto mt-0">
        <div className="relative flex flex-col items-center lg:px-0">
          <div className="flex flex-col cursor-pointer w-full">
            <div className="animate-pulse relative p-[0px] lg:-m-[2px] w-full h-auto border-[18px]  transition-all border-white outline-1">
              <div className="bg-gray-300 w-[242px] h-[242px] mx-auto" />
            </div>
            <div className="animate-pulse pl-6 mt-6  overflow-hidden text-ellipsis">
              <div className="bg-gray-300 min-h-[15px] rounded-xl" />
            </div>
            <div className="h-14 pt-1 pl-6">
