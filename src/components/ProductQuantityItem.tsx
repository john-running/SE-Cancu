...
const ProductQuantityItem: FC<Props> = ({ availability, quantity, onClickIncrement, onClickDecrement }) => (
  <div className="flex justify-between flex-row lg:w-48 w-40 max-h-13 border border-gray-100">
    <Button.Action
      styleType="arrow"
      disabled={!availability || quantity === 1}
    ...
    <Button.Action
      ...
      styleType="arrow"
      className="bg-white !border-0 !border-l"
